-- 31.Diferenças entre as Visões com prefixo USER, ALL e DBA
/*
-- Diferenças entre as Visões com prefixo USER, ALL e DBA
   > Tipos de prefixo:
     - USER: inclui objetos do schema do usuário que estar conectado
     - ALL: inclui objetos do schema do usuário que estar conectado e objetos que
     o usuário possui privilégios de acesso
     - DBA: inclui todos os objetos do banco de dados. Somente os DBA´s ou usuário
     para os que possuem os privilégios necessário podem acessar
*/

-- Conectar como usuário HR
-- Todos os objetos do usuário no schema 
SELECT *
FROM USER_OBJECTS;

-- Todos os objectos que o usuário possui e objetos com privilégios
SELECT *
FROM ALL_OBJECTS;
